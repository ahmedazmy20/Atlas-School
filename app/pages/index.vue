...
<template>
  <div
    ...
    <!-- Left -->
    <div
      class="left w-full h-screen flex items-center justify-center px-10 md:px-20 py-20 transition-colors duration-300 bg-white dark:bg-gray-800">
    ...
    <div
      ...
      <div
        ...
        <div class="flex flex-col items-center">
          ...
          <h6 class="font-medium text-xl text-gray-100 dark:text-gray-300">
            {{ t("education") }}
          </h6>
          <p
        ...
        <div
          ...
          <div
            ...
            <h2 class="font-bold text-xl text-white dark:text-gray-300">
              {{ t(card.title) }}
            </h2>
            <p
              class="mt-2 text-center max-w-[240px] text-gray-200 dark:text-gray-300 text-sm font-medium">
              {{ t(card.description) }}
            </p>
          </div>
        </div>
